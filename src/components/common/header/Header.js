...
export default function Header() {
    ...
    const minMobileScreenWidth = process.env.REACT_APP_MOBILE_MIN_SCREEN_WIDTH;
    useEffect(() => {
        setScreenWidth(window.screen.width);
        if (minMobileScreenWidth <= window.screen.width)
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='d-flex align-items-center'>
                                <div className='brand'>
                                    <div className='col-auto d-flex align-items-center brand-item'>
                                        <div className='bar-icon mx-2'>
                                            ...
                                            <i className="bi bi-list" onClick={e => setDisplaySideMenu(pre => !pre)}></i>
                                        </div>
                                        <div className='bar-icon mx-2'>
                                ...
                                {((screenWidth < minMobileScreenWidth && displaySideMenu) || screenWidth >= minMobileScreenWidth) && <div className='col d-flex flex-row-reverse'>
